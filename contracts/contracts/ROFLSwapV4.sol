 ...
 * 
 * Key improvements over the V3 implementation:
 * - Uses bytes instead of bytes21 for the ROFL app ID to support full-length IDs
 * - No more truncation issues with ROFL app IDs
 * - Same functionality otherwise
 */
contract ROFLSwapV4 is Ownable {
    // Types
    struct Order {
        uint256 orderId;
        address owner;
